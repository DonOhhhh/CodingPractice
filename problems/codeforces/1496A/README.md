# [Codeforces 1496A : Split it!](https://codeforces.com/problemset/problem/1496/A)
...
For each test case, print "$\mathtt{YES}$" (without quotes), if it is possible to find $a_1,a_2,\ldots,a_{k+1}$, and "$\mathtt{NO}$" (without quotes) otherwise.
