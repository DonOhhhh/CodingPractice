# [Codeforces 2110B : Down with Brackets](https://codeforces.com/problemset/problem/2110/B)
...
$\texttt{(())}\color{red}{\texttt{(}}\color{white}\texttt{)(}\color{red}{\texttt{)}} \rightarrow \color{white}\texttt{(()))(}$, which is not a correct bracket sequence.

In the fourth test case, one of the options for removal is as follows:

$\texttt{(}\color{red}{\texttt{(}}\color{white}\texttt{))((}\color{red}{\texttt{)}}\color{white}\texttt{)}\rightarrow \texttt{())(()}$, which is not a correct bracket sequence.
